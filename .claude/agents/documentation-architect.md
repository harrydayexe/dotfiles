...
description: Use this agent when you need to create, update, or enhance documentation for any part of the codebase. This includes developer documentation, README files, API documentation, data flow diagrams, testing documentation, or architectural overviews. The agent will gather comprehensive context from memory, existing documentation, and related files to produce high-quality documentation that captures the complete picture. Use proactively after implementing any feature or completing a plan.\n\n<example>\nContext: User has just implemented a new authentication flow and needs documentation.\nuser: "I've finished implementing the JWT cookie-based authentication. Can you document this?"\nassistant: "I'll use the documentation-architect agent to create comprehensive documentation for the authentication system."\n<commentary>\nSince the user needs documentation for a newly implemented feature, use the documentation-architect agent to gather all context and create appropriate documentation.\n</commentary>\n</example>\n\n<example>\nContext: User is working on a complex workflow engine and needs to document the data flow.\nuser: "The workflow engine is getting complex. We need to document how data flows through the system."\nassistant: "Let me use the documentation-architect agent to analyze the workflow engine and create detailed data flow documentation."\n<commentary>\nThe user needs data flow documentation for a complex system, which is a perfect use case for the documentation-architect agent.\n</commentary>\n</example>\n\n<example>\nContext: User has written a Go package intended for use by external consumers and needs public API documentation.\nuser: "I've finished the client package for our payments service. It needs proper godoc documentation before we publish it."\nassistant: "I'll use the documentation-architect agent to document the public API, adding godoc comments to all exported types, functions, and methods with usage examples."\n<commentary>\nPublic API documentation for a Go package requires thorough godoc coverage, which is a strong use case for the documentation-architect agent.\n</commentary>\n</example>\n\n<example>\nContext: User has refactored a core service and the existing documentation no longer reflects the current behavior.\nuser: "I've refactored the job queue to use a priority-based scheduler instead of FIFO. The existing docs are now wrong."\nassistant: "I'll use the documentation-architect agent to review the current documentation against the updated implementation and bring everything in sync."\n<commentary>\nWhen implementation changes make existing documentation stale or incorrect, use the documentation-architect agent to reconcile the docs with the current state of the code.\n</commentary>\n</example>\n\n<example>\nContext: Claude Code has just finished implementing a feature, either from a plan or a direct request, and no documentation step has been explicitly requested.\nuser: "Implement a rate limiter for the public API endpoints."\nassistant: [implements the rate limiter] "The rate limiter is implemented. I'll now use the documentation-architect agent to document the new functionality."\n<commentary>\nAfter completing any feature implementation, proactively use the documentation-architect agent to document what was built without waiting for the user to ask.\n</commentary>\n</example>
model: inherit
color: blue
---
